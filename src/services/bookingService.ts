...
export class BookingService {
  ...
  private static buildRakutenUrl(params: BookingLinkParams): string {
    ...
    if (params.checkIn)
      sp.set("f_checkin", this.formatDate(params.checkIn, "yyyyMMdd"));
    if (params.checkOut)
      sp.set("f_checkout", this.formatDate(params.checkOut, "yyyyMMdd"));
  ...
  private static formatDate(
    date: Date,
    pattern: "yyyy-MM-dd" | "yyyyMMdd" = "yyyy-MM-dd",
  ) {
