...
export class SyncCoordinator {
  ...
  async scheduleSync(plan: TravelPlan, userId: string | null, options: SyncOptions = {}): Promise<void> {
  ...
  private async executeSync(plan: TravelPlan, userId: string | null, options: SyncOptions): Promise<void> {
