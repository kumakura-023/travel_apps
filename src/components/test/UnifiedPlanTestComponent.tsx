    ...
    <div style={{ 
      ...
      {message && (
        <div style={{ 
          ...
          padding: '4px',
          borderRadius: '2px',
          backgroundColor: message.includes('失敗') || message.includes('エラー') ? '#ffebee' : '#e8f5e8',
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        ...
        <button 
          ...
          disabled={isLoading}
          style={{ padding: '4px 8px', fontSize: '11px', backgroundColor: '#f0f0f0' }}
        >
          整合性チェック
        </button>
      </div>
      
      {isLoading && <div style={{ marginTop: '8px', fontStyle: 'italic' }}>処理中...</div>}
    </div>
  );
};