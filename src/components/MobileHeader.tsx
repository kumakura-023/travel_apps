    ...
    <>
      ...
      >
        ...
        <div className="flex-shrink-0">
          {isLoading ? (
            <div
              className={`glass-effect-border rounded-2xl ${getPaddingClass()} inline-block
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <span className="text-system-secondary-label text-xs">
                  読み込み中...
                </span>
              </div>
            </div>
            ...
            <div
              className={`glass-effect-border rounded-2xl ${getPaddingClass()} inline-block
                           shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.08)]`}
            >
              <div className="text-red-500 text-xs">エラー: {error}</div>
            </div>
          ) : !plan ? (
            <div
              className={`glass-effect-border rounded-2xl ${getPaddingClass()} inline-block
              ...
              <div className="flex flex-col space-y-0.5">
                ...
                {dateInfo && (
                  <div className="flex items-center justify-center space-x-1.5">
                    ...
                    <div
                      className="bg-coral-500/10 text-coral-600 px-1.5 py-0.5 rounded-full 
        ...
        <div className="absolute right-0 flex items-center space-x-2">
          {/* Auth Button */}
          <div
            className="glass-effect-border rounded-2xl p-2
                          shadow-[0_2px_8px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.08)]
