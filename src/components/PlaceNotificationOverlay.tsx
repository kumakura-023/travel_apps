...
export const PlaceNotificationOverlay: React.FC<
  PlaceNotificationOverlayProps
> = ({ notification, onConfirm, position }) => {
    ...
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow =
          "0 6px 16px rgba(0, 0, 0, 0.12), 0 12px 32px rgba(0, 0, 0, 0.16)";
      }}
      onMouseLeave={(e) => {
