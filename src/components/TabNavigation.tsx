...
const TabNavigation: React.FC<Props> = ({ active, onChange, isVisible }) => {
  ...
  return (
    <nav
      className={`glass-effect-border rounded-xl flex flex-col items-center py-3 z-40 transition-all duration-300 ease-ios-default ${isVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0 pointer-events-none"}`}
    >
      <AuthButton />
      ...
      >
        ...
        <span className="caption-2 mt-1 select-none font-medium">通知</span>
      </button>
