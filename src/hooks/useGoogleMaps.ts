...
export function useGoogleMaps() {
  ...
  let sharedMap: google.maps.Map | null =
    (globalThis as any).__TRAVEL_MAP_INSTANCE__ || null;
  ...
  useEffect(() => {
    const globalMap = (globalThis as any)
      .__TRAVEL_MAP_INSTANCE__ as google.maps.Map | null;
