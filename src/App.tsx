...
function App() {
  ...
  // 自動保存フックを使用
  const { saveImmediately, saveImmediatelyCloud, saveWithSyncManager } =
    useAutoSave(plan, updateLastSavedTimestamp);
  ...
  return (
    ...
    >
      {/* Navigation */}
      <TabNavigationWrapper activeTab={activeTab} onTabChange={setActiveTab} />
      ...
      <MapContainer showLabelToggle={false} />
