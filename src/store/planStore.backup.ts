...
export const usePlanStore = create<PlanState>((set, get) => ({
  ...
  listenToPlan: () => {
    console.warn(
      "[planStore] listenToPlan is deprecated. Use PlanCoordinator instead.",
    );
  },
  unsubscribeFromPlan: () => {
    console.warn(
      "[planStore] unsubscribeFromPlan is deprecated. Use PlanCoordinator instead.",
    );
  },
  updateLastActionPosition: async () => {
    console.warn(
      "[planStore] updateLastActionPosition is deprecated. Use PlanService instead.",
    );
  },
  setActivePlanId: async () => {
    console.warn(
      "[planStore] setActivePlanId is deprecated. Use ActivePlanService instead.",
    );
  },
}));
