...
export const usePlanStore = create<PlanState>((set, get) => {
  ...
  return {
    ...
    clearPlan: () =>
      set({ currentPlan: null, plan: null, error: null, isLoading: false }),
    ...
    listenToPlan: () => {
      console.warn(
        "[planStore] listenToPlan is deprecated. Use UnifiedPlanService or PlanLifecycleManager instead.",
      );
    },
    unsubscribeFromPlan: () => {
      console.warn(
        "[planStore] unsubscribeFromPlan is deprecated. Use UnifiedPlanService or PlanLifecycleManager instead.",
      );
    },
    updateLastActionPosition: async () => {
      console.warn(
        "[planStore] updateLastActionPosition is deprecated. Use UnifiedPlanService instead.",
      );
    },
    setActivePlanId: async () => {
      console.warn(
        "[planStore] setActivePlanId is deprecated. Use UnifiedPlanService instead.",
      );
    },
  };
});
